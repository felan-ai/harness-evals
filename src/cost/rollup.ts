...
export function costReportFromJudgeAssertions(
  ...
  for (const assertion of assertions) {
    ...
    const usageReport = provider && model ? pruneRecord({
      ...
      uncachedInputTokens: numberOrUndefined(usage?.uncachedInputTokens),
      cacheReadInputTokens: numberOrUndefined(usage?.cacheReadInputTokens),
      cacheWriteInputTokens: numberOrUndefined(usage?.cacheWriteInputTokens),
...
function rollupFromReport(report: CostReport): CostRollup {
  ...
  return pruneRecord({
    ...
    promptTokens: sumField(report, 'promptTokens'),
    uncachedInputTokens: sumField(report, 'uncachedInputTokens'),
    cacheReadInputTokens: sumField(report, 'cacheReadInputTokens'),
    cacheWriteInputTokens: sumField(report, 'cacheWriteInputTokens'),
...
function bucketToRollup(bucket: Bucket): CostRollup {
  ...
  return pruneRecord({
    ...
    promptTokens: bucket.fields.promptTokens,
    uncachedInputTokens: bucket.fields.uncachedInputTokens,
    cacheReadInputTokens: bucket.fields.cacheReadInputTokens,
    cacheWriteInputTokens: bucket.fields.cacheWriteInputTokens,
